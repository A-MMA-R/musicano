...
🎗 [{BOT_NAME}](https://t.me/{BOT_USERNAME}) **انا بوت استطيع تشغيل الاغاني والموسيقي في الدردشة الصوتية** 
...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "◜التواصل مع المطور◞", url="https://t.me/X_A_R3"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("اوامر التشغيل", url=f"https://t.me/V_III_B"),
                InlineKeyboardButton(
                    "مطور السورس", url=f"https://t.me/X_A_R3"
                ),
            ]
        ]
    )
